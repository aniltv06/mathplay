 ...
 * Interactive fractions and decimals learning
      ...
      <div className="relative z-10 px-4 py-8 min-h-screen flex flex-col items-center justify-center">
        ...
        >
          <motion.div
            ...
            className="w-24 h-24 mx-auto mb-6 rounded-2xl bg-gradient-to-br from-blue-400 to-indigo-500 flex items-center justify-center"
          >
            <Percent className="w-12 h-12 text-white" />
          </motion.div>

          <h1 className="text-5xl mb-6 text-blue-600">
            Fractions & Decimals
          </h1>
          ...
          <p className="text-xl text-gray-600 mb-8">
            Master fractions, decimals, and percentages with fun, visual learning activities.
          </p>

          <div className="bg-blue-50 rounded-2xl p-6 text-left">
            <h3 className="text-lg font-bold text-blue-700 mb-3">What's Coming:</h3>
            <ul className="space-y-2 text-gray-700">
              <li className="flex items-start gap-2">
                <span className="text-blue-500">✓</span>
                <span>Introduction to fractions (halves, thirds, fourths)</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-blue-500">✓</span>
                <span>Visual fraction representations with pizza & pie slices</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-blue-500">✓</span>
                <span>Comparing and ordering fractions</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-blue-500">✓</span>
                <span>Decimal concepts (tenths, hundredths)</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-blue-500">✓</span>
              ...
              <li className="flex items-start gap-2">
                <span className="text-blue-500">✓</span>
                <span>Money and decimal practice</span>
              </li>
            </ul>
          </div>
        </motion.div>
